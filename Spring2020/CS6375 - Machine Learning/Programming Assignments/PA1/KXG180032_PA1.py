...
#In the end Using sklearn and graphviz library, it computes the tree, and the confusion matrix for the given datasets.
...
#For debugging purposes the 'VERBOSE' flag can be turned on
...
if __name__ == '__main__':
	...
	for train,test,name in zip(sklearn_training_set,sklearn_testing_set,sklearn_names_set):
		...
		#The below two lines uses graphviz to generate a pdf file of the decision tree
		graph = graphviz.Source(dot_data) 
		graph.render(name + "_decision_tree")
		#The below two lines can give the text output of the learned tree from sklearn
		# r = export_text(clf)
		# print(r)
