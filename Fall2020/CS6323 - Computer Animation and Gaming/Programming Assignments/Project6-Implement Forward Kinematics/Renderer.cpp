...
float rotate_x1 = 0, rotate_y1 = 0, rotate_z1 = 0;
float rotate_x2 = 0, rotate_y2 = 0, rotate_z2 = 0;
float rotate_x3 = 0, rotate_y3 = 0, rotate_z3 = 0;
...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	static auto x1 = gui_1->addVariable("Rotate X1", rotate_x1);
	static auto y1 = gui_1->addVariable("Rotate Y1", rotate_y1);
	static auto z1 = gui_1->addVariable("Rotate Z1", rotate_z1);

	static auto x2 = gui_1->addVariable("Rotate X2", rotate_x2);
	static auto y2 = gui_1->addVariable("Rotate Y2", rotate_y2);
	static auto z2 = gui_1->addVariable("Rotate Z2", rotate_z2);

	static auto x3 = gui_1->addVariable("Rotate X3", rotate_x3);
	static auto y3 = gui_1->addVariable("Rotate Y3", rotate_y3);
	static auto z3 = gui_1->addVariable("Rotate Z3", rotate_z3);

	x1->setSpinnable(true);
	y1->setSpinnable(true);
	z1->setSpinnable(true);

	x2->setSpinnable(true);
	y2->setSpinnable(true);
	z2->setSpinnable(true);

	x3->setSpinnable(true);
	y3->setSpinnable(true);
	z3->setSpinnable(true);

	gui_1->addButton("Reset Bone Rotation", []() {
		m_bone_animation->reset();
		x1->setValue(rotate_x1 = 0);
		y1->setValue(rotate_y1 = 0);
		z1->setValue(rotate_z1 = 0);

		x2->setValue(rotate_x2 = 0);
		y2->setValue(rotate_y2 = 0);
		z2->setValue(rotate_z2 = 0);

		x3->setValue(rotate_x3 = 0);
		y3->setValue(rotate_y3 = 0);
		z3->setValue(rotate_z3 = 0);
		});
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
	...
	// Rotation axis in order - y,z,x 
	// So multiplication should be like Rotx * Rotz * Roty * Matrix
	first_bone_rot_mat = glm::rotate(first_bone_rot_mat, glm::radians(rotate_x1), glm::vec3(1, 0, 0));
	first_bone_rot_mat = glm::rotate(first_bone_rot_mat, glm::radians(rotate_z1), glm::vec3(0, 0, 1));
	first_bone_rot_mat = glm::rotate(first_bone_rot_mat, glm::radians(rotate_y1), glm::vec3(0, 1, 0));
	...
	root_bone_obj_mat = glm::translate(root_bone_obj_mat, glm::vec3(0, 0.5f, 0));
	...
	// Rotation axis in order - y,z,x 
	// So multiplication should be like Rotx * Rotz * Roty * Matrix
	second_bone_rot_mat = glm::rotate(second_bone_rot_mat, glm::radians(rotate_x2), glm::vec3(1, 0, 0));
	second_bone_rot_mat = glm::rotate(second_bone_rot_mat, glm::radians(rotate_z2), glm::vec3(0, 0, 1));
	second_bone_rot_mat = glm::rotate(second_bone_rot_mat, glm::radians(rotate_y2), glm::vec3(0, 1, 0));
	...
	// Rotation axis in order - y,z,x 
	// So multiplication should be like Rotx * Rotz * Roty * Matrix
	third_bone_rot_mat = glm::rotate(third_bone_rot_mat, glm::radians(rotate_y3), glm::vec3(0, 1, 0));
	third_bone_rot_mat = glm::rotate(third_bone_rot_mat, glm::radians(rotate_z3), glm::vec3(0, 0, 1));
	third_bone_rot_mat = glm::rotate(third_bone_rot_mat, glm::radians(rotate_x3), glm::vec3(1, 0, 0));
